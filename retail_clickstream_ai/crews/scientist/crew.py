...
_MAX_ITER = {
    "contract_feature_engineer": 9,
    "model_trainer": 8,
    "evaluation_governance": 10,
}
...
# The two longest tool chains get one extra guardrail retry.
_HANDOFF_FILENAMES = {
    "contract_feature_engineer": "feature_engineering_handoff.json",
    "model_trainer": "training_handoff.json",
    "evaluation_governance": "scientist_crew_handoff.json",
}
_HANDOFF_TOOL_NAMES = {
    "contract_feature_engineer": "write_feature_engineering_handoff",
    "model_trainer": "write_training_handoff",
    "evaluation_governance": "write_scientist_handoff",
}
_GUARDRAIL_MAX_RETRIES = {
